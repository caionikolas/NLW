    ...
    <main className="grid min-h-screen grid-cols-2">
      ...
      <div className="relative flex flex-col items-start justify-between overflow-hidden border-r border-white/10 bg-[url(../assets/bg-stars.svg)] bg-cover px-20 py-16 ">
        ...
        {/* Copyright */}
          <div className='text-sm leading-relaxed text-gray-200'>
            Feito com 💜 no NLW da <a href="#" className='underline hover:text-gray-100'>Rocketseat</a>
          </div>
      </div>
      ...
      <div className="flex flex-col p-16 bg-[url(../assets/bg-stars.svg)] bg-cover">
        <div className="flex flex-1 items-center justify-center">
          ...
          <a href="#" className="underline hover:text-gray-50" target='_blank' rel='noreferrer'>criar agora!</a></p>
        </div>
      </div>
    </main>  
  )
